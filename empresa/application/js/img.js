...
function form_galeria(){
    url =  "../imgs/index.php/api/empresa/form_galeria/format/json/";    
    $.ajax({
        url : url , 
        type : "GET" ,
        data :  {},
...
function carga_form_imagenes_empresa_logo(){    
    url =  "../imgs/index.php/api/empresa/form_logo/format/json/";    
    $.ajax({
        url : url , 
        type : "GET" ,
        data :  {},
...
function registra_img_logo(e){
    ...
    $.ajax({
        ...
        url_img = "../imgs/index.php/enid/imagen_empresa"+"/"+id_empresa;
