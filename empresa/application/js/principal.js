...
function try_update_mas_info(){	
	...
	if (in_session == 1){
		...
		$("#mas-info-empresa-input").blur(function(){
			flag =  valida_text_form("#mas-info-empresa-input" , ".response-update-mas-info" ,5  , "Texto descriptivo " ); 			
			if (flag ==  1) {
				cadena =  $(this).val();  
...
function try_update_vision(){
	...
	if (in_session ==1){
		...
		$("#descripcion-vision-input").blur(function(){
			flag =  valida_text_form("#descripcion-vision-input" ,".response-update-vision" , 5  , "Texto  descriptivo "); 
			if (flag ==  1 ) {
				cadena =  $(this).val(); 	
...
function try_update_mision(){
	...
	if (in_session == 1){
		...
		$("#mision-empresa-input").blur(function(){	
			flag= valida_text_form("#mision-empresa-input" , ".response-update-mision" , 5 ,"Texto descriptivo" ); 
			if (flag ==  1 ) {
				cadena =  $(this).val();  	
...
function try_update_descripcion(){
	...
	if (in_session==1 ){		
		...
		$("#descripcion-empresa-input").blur(function(){
			cadena =  $(this).val();  				
			flag =  valida_text_form(".descripcion-empresa-input" , ".place_descripcion" , 5 , "Descripción de la empresa " ); 			
			if (flag ==  1){
...
function edita_mensaje_comunidad(){	
	...
	$("#comunidad-mensaje-input").blur(function(){				
			...
			if (flag == 1){
				...
				url =  "../empresas/index.php/api/emp/mensaje_comunidad/format/json/";    
...
function carga_url_socials(social, input ){	
	url = "../empresas/index.php/api/emp/q/format/json/";
	$.ajax({
		url :  url , 
		type :  "GET",
		data :  {"q":  social}, 
...
function carga_eventos_empresa(){
	...
	url = "../q/index.php/api/busqueda/eventos_empresa_resumen/format/json/";  		
...
function carga_galeria_images_empresa(){
	...
	url  = "../imgs/index.php/api/empresa/galeria/format/json/"; 
	id_empresa = $(".id_empresa").val();
...
function delete_img_galeria(){
	/**/	
	url =  "../empresas/index.php/api/img_controller/imagen_galeria_empresa/format/json/";
	$.ajax({
		url : url  ,
		type : "DELETE",
