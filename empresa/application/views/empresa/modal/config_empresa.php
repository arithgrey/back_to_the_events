<?=construye_header_modal('reservaciones-modal', "Reservaciones" );?>                           
   <form class='form-servaciones' id='form-servaciones'
    action="../empresas/index.php/api/emp/reservacion/format/json/">  
        <label>
...
<?=construye_header_modal('modal-locacion', " Logo de la empresa  " );?>
	<form class='form-paises' id='form-paises' action="../empresas/index.php/api/emp/pais/format/json/">
...
<?=construye_header_modal('modal-social-empresa', " <div class='title-modal-social  modal-title' id='title-modal-social'  ></div> " );?>
				...
				<div id='section-form-url-fb'>
					<form action="../empresas/index.php/api/emp/q/format/json/" id="form-social-fb" class='form-social-fb'>
	         	...
	         	<div id='section-form-url-tw' >
	         		<form action="../empresas/index.php/api/emp/q/format/json/" id="form-social-tw" class='form-social-tw'>
				      	<div class="form-group">            
		                    <div class="input-group m-bot15">
		                       <span class="input-group-addon">
		                            https://twitter.com/
	         	...
	         	<div id='section-form-url-gp' >
	         		<form action="../empresas/index.php/api/emp/q/format/json/" id="form-social-gp" class='form-social-gp'>
				      	<div class="form-group">            
				             <div class="input-group m-bot15">
				                <span class="input-group-addon">
				                    G + 
	         	...
	         	<div id='section-form-url-www' class='section-form-url-www'>
	         		<form action="../empresas/index.php/api/emp/q/format/json/" id="form-social-www" class='form-social-www'>
				      	<div class="form-group">            
				             <div class="input-group m-bot15">
				                <span class="input-group-addon">
				                    wwww + 
...
<?=construye_header_modal('modal-ubicacion-empresa', "Locación de tu centro nocturno");?>
	...
	<form id='form-direccion-emp' action="../empresas/index.php/api/emp/direccion/format/json/">
...
<?=construye_header_modal('modal-contacto-empresa', "+ información de contacto");?>
    ...
    action="../empresas/index.php/api/emp/infocontacto/format/json/">  
        <label>
