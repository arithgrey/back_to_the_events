...
function carga_informe_global(){
	/**/
	url = "../q/index.php/api/reportes/global_empresa/format/json/"; 		
	$.ajax({ 
			url : url , 
			method: "GET",			
...
function carga_solicitados_artistas(){
	/**/
	url = "../q/index.php/api/emp/solicitud_ciudad/format/json/";
...
function carga_ultimos_movimientos(){
	/**/
	url = "../q/index.php/api/emp/actividades/format/json/";
	$.ajax({
		url :  url , 
...
function carga_info_accesos(e){
	...
	if (evento > 0 ){
		...
		url  =  "../q/index.php/api/accesos/accesos_evento/format/json/"; 
		$.ajax({
			url : url , 
			type : "GET" ,
			data : {"evento" : evento },
...
function carga_info_artistas(e){
	...
	if(evento > 0){
		...
		url = "../q/index.php/api/escenario/artistas_evento/format/json/";		
		$.ajax({
			url : url , 
			type :  "GET",
...
function carga_usuario_reservacion(e){
	...
	url = "../q/index.php/api/event/reservaciones/format/json/";
	$.ajax({
			url : url , 
			type :  "GET",
