 ...
 $show_view_like_public = 0 , $show_emp = 0){	
		...
		if ($ultimos_eventos["num_eventos"] == 0  ) {
			...
			if ($show_emp ==  1){
				...
				$url_empresa = create_url_evento_view($id_empresa);				
				$nombreempresa =  $row["nombreempresa"];	
				$text_public =  "<a href='". $url_empresa ."' class='btn-empresa-link'> By " .$nombreempresa ."</a>";
			}
						
			$btn_social_fb =  n_row_12().' <div class="fb-share-button" data-href="'.$url_next.'" data-layout="button" data-size="small" data-mobile-iframe="true">
            ...
            <div class="row">   
			    ...
			    <div class="col-lg-7 col-md-7 col-sm-12">
			    	<div class="seccion-r-eventos">
						...
						'. n_row_12("contenedor-resum-event").'    
	                    	<span class="text-resumen-evento black strong">	                    	
		                    	'. substr( $descripcion_evento , 0 ,  110 )  .' ... 
		                    </span>
		                '.end_row().'    
