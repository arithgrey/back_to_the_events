...
/**/
function valida_largo_resumen($text){
    
}
/**/
function crea_parte_social_artista($param){
        
        $hora_inicio         = $param["hora_inicio"]; 
        $hora_termino        = $param["hora_termino"]; 
        $url_social_youtube  = $param["url_social_youtube"]; 
        $url_sound_cloud     = $param["url_sound_cloud"]; 
        $status_confirmacion = $param["status_confirmacion"];         
        $hora = hora_enid_format($hora_inicio , $hora_termino );
    



        $icono_youtube = "<i class='fa fa-youtube-play url_youtube ' id='".$url_social_youtube."' ></i>"; 
        $icono_sound = "<i class='fa fa-play-circle url_sound_cloud' id='".$url_sound_cloud."'></i>"; 
        
    return $hora."|".$icono_youtube."|".$icono_sound."|".$status_confirmacion ;
}
/*new*/
function crea_seccion_artista_evento($data){
    ...
    foreach ($data as $row) {
        ...
        $part_social_artista = crea_parte_social_artista($row);

    
        $artistas .='<a class="list-group-item background_panel_enid_artistas " >            
                        <div class="col-md-4">                            
                            '.create_img_enid(create_url_img_artista($id_artista)).'                            
                        </div>
                        <div class="col-md-8 " style="background:white; height:205px;" >
                            '.titulo_enid( $nombre_artista).'                       
                            <h3 style="font-size:.9em !important;" class="strong">
                            '.$tipo_artista.'
                            </h3>
