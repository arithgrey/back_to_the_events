<?php
	...
	foreach ($artistas as $row){
		...
		if ($public == 0 ){
				...
				$m_horario = ' title="Horario de presentación "  data-toggle="modal" data-target="#modal_record_horario"  ';
				$m_youtube = ' title="Video de youtube" data-toggle="modal" data-target="#modal_link_youtube"   '; 
				$m_sound = ' data-toggle="modal"  title="Sound cloud"  data-target="#modal_link_sound"  ';			
		...
		$list_artistas .=  '
			...
			<div class="well background_panel_enid_artistas contenedor_resumen_artista" >
					...
					<div>						
		                <div>              
		                   	<div class="col-lg-3  col-md-3 col-sm-12">
			                   	<div class="blog-img-sm" title="Artista '.$nombre_artista.' " alt="Imagen del artista '.$nombre_artista.'">
			                        '.$img.'
			                   	</div>
		                   	</div>
		                    <div class="col-lg-9 col-md-9 col-sm-12 contenedor_resumen_artista_sub" style="background:white;" >                           		                 

					            <h2  class="titulo_enid_service" "'. $m_nombre_artista .'"  >
...
.registro_sound_cloud{
	color: #F50;	
}

.sin_registro_youtube{
	color: black;
}
.registro_youtube{
	color: red;
...
.contenedor_resumen_artista{
	height: 220px;
}
.contenedor_resumen_artista_sub{
	height: 170px;
}
/**/
</style>		        
