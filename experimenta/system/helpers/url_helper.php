...
if ( ! function_exists('url_solicita_artista'))
{
	function url_solicita_artista($id_empresa){
		return  "../solicitud_artistas/?q=".$id_empresa;
	}	
}
if ( ! function_exists('url_opiniones')){
	
	function url_opiniones($id_empresa){
		return "../opiniones/?q=".$id_empresa;    
	}
}
/**/
if ( ! function_exists('url_web_empresa')){
	function url_web_empresa($id_empresa){
		return "../empresa/?q=".$id_empresa;    
	}
}
...
if(! function_exists('url_templates')){    
	function url_templates($extra){		
		return '../administracion_plantillas/?q='.$extra;
	}	
}
