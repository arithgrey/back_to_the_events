...
if ( ! function_exists('valida_info_completa_resumen'))
{
  function valida_info_completa_resumen($text , $class ,  $extra ){

    $n_text =  "<p class='list-group-item-text'>                         
                ".$text ."
                </p>"; 

    if (trim(strlen($text)) > 450  ) {

      $n_text =  "<p class='list-group-item-text  ' ".$extra." >                         
                ". substr( $text, 0 , 450 ) ." 
                    <span> 
                      <strong>... más info 
                      </strong>
...
if ( ! function_exists('template_editar_s'))
{
  function template_editar_s( $in_session,  $url){
      ...
      if ($in_session ==  1 ){
        ...
        return "<i class='fa fa-pencil enlance_next' id='".$url."' ></i>";  
...
if ( ! function_exists('btn_eliminar'))
{
  function btn_eliminar($id , $class , $extra = '' )
  {
    return "<button style='background:red!important; color:white;' 
            type='submit' id='".$id ."' class='button-registrar  
            btn btn-default eliminar_btn ".$class." ' $extra> 
               Eliminar 
            </button>"; 
  }
}
...
if ( ! function_exists('btn_registrar_cambios_enid'))
{
  ...
  {
    return "<button type='submit' id='".$id ."' class='button-registrar  
    btn btn-default ".$class." ' $extra> 
                Registrar
            </button>"; 
  }
}
