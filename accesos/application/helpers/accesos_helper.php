...
if(!function_exists('invierte_date_time')){
	/**/
	function valida_modal_info_nota($in_session){
		$part_img_modal =  "";
		if($in_session == 1 ){                                                     
                $part_img_modal = 'data-toggle="modal" data-target="#acceso-imagen-modal"';                                               
        }
		return $part_img_modal;
	}
	/**/
	function valida_botomes_configuracion($resumen_evento ,  $in_session ,  $url_config  ,  $idacceso  ){
			...
			$config = n_row_12(). '                                        
                <div class="pull-right"> 
                    <a title = "Configura datos del acceso "  class="more">
                        <i data-toggle="modal" data-target="#editar-acceso" class="fa fa-cog editar-acceso white" 
                            id="'.$idacceso.'">
                        </i> 
                    </a>
                    <a title = "Eliminar acceso del evento "  class="more ">
                        <i data-toggle="modal" data-target="#confirma-delete-acceso" 
                                                class="fa fa-times delete-acceso red" id="'.$idacceso.'" >
                        </i> 
                    </a>
                </div>'.
			end_row(); 
			   ...
			   $config = n_row_12().'
	                <div class="pull-right"> 
	                    <a href="'.$url_config.'" title = "Configura datos del acceso "  class="more">
	                        <i  class="fa fa-cog editar-acceso white" id="'.$idacceso.'">
	                        </i> 
	                    </a>                                            
	                </div>'.
                end_row(); 
	...
	/**/
	function valida_formato_precio($precio , $moneda ){
	...
	function show_more_text($nota , $nombre_acceso  , $info_extra = '' ){

		$n_nota =  $nota; 
		if ( strlen(trim($nota) ) > 100 ) {			
			$n_nota =   "<div ".$info_extra." 
							info_nombre_acceso= '". $nombre_acceso."'  
							info_nota='".$nota."' 
							class='resumen_info_acceso black strong'> ". substr($nota, 0 , 90 ) . "... </div>";			
		}
		return $n_nota;
	}
	/**/
